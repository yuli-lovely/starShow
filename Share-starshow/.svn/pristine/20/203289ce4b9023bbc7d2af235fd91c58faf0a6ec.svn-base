 ...
 */
	var ADSupportsTouches = ("createTouch" in document) || ('ontouchstart' in window) || 0,
		...
		TouchSlider=function(opt){
			...
			try{
				...
				if(this.opt.id==="slider1")
				{
					this.setup("this.width*9/16");
				}else
				{
					this.setup("this.height");
				}
	...
	TouchSlider.prototype={
		...
		resize:function(a){
			...
			var nsMoreLeft=navWidth*0.28+navWidth*0.17*3;
			$(".nsMore").css("left",nsMoreLeft);	
			var css;
